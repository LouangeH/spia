    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_certificate', models.FileField(blank=True, null=True, upload_to='admissions/')),
                ('passport_photo', models.FileField(blank=True, null=True, upload_to='admissions/')),
                ('last_report_card', models.FileField(blank=True, null=True, upload_to='admissions/')),
                ('transfer_letter', models.FileField(blank=True, null=True, upload_to='admissions/')),
                ('immunization_records', models.FileField(blank=True, null=True, upload_to='admissions/')),
